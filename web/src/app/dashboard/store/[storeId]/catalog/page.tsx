...
/**
 * /dashboard/store/[storeId]/catalog — Catálogo elegível para try-on (portal lojista)
 *
...
import {
  Search, Settings2, ShoppingBag, LayoutDashboard, Database,
  ...
  return (
    <div className="max-w-4xl space-y-8">
      ...
      <div className="flex gap-1 border-b border-border pb-0">
        ...
        <Button asChild variant="ghost" size="sm" className="font-mono text-xs text-muted-foreground hover:text-primary gap-1.5">
          <Link href={`/dashboard/store/${storeId}/settings`}>
